...
sys.path.insert(0, os.path.dirname('../matgendb'))
sys.path.insert(0, os.path.dirname('../..'))

from matgendb import __version__, __author__
...
latex_documents = [
  ('index', 'pymatgen_db.tex', u'pymatgen-db Documentation', __author__,
   'manual'),
  ]
...
man_pages = [
    ('index', 'pymatgen_db', u'pymatgen_db Documentation',
     [__author__], 1)
]
...
texinfo_documents = [
  ('index', 'pymatgen_db', u'pymatgen_db Documentation',
   __author__, 'pymatgen_db', 'One line description of project.',
   'Miscellaneous'),
]
